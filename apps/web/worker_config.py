...
DEFAULT_WORKER_PROFILES = [
    ...
    # model 钉 opencode-go 的 deepseek-v4-flash:v4-pro 正式版推出前 flash
    # (0731) 显著更强且更便宜;要换模型改这里的 model 即可(--model 透传),
    # 或改 ~/.config/opencode/opencode.jsonc 的全局默认。
    {"id": "opencode-sub-container", "name": "opencode-sub-container",
     ...
     "wire_api": "",
     "runtime": "docker-web", "roles": ["race", "bootstrap", "explore", "review"],
     "race": True, "max_running": 1, "max_review_running": 0, "priority": 40,
