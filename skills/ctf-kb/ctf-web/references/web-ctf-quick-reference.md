...
| 特征 | 可能编码 | 解码方法 |
|------|---------|---------|
| 末尾有 `=` | Base64 | python3 base64 |
| `0-9a-f` 偶数长度 | Hex | python3 binascii |
| `%XX` | URL 编码 | python3 urllib.parse |
| `&#xNN;` | HTML 实体 | python3 html |
| `\uXXXX` | Unicode 转义 | python3 codecs |
| 三段 `.` 分隔 | JWT | python3 jwt 库 |
| 点划线 | Morse | 自写 python3 脚本 |
| 看不懂但像字母 | ROT13/Caesar | python3 str.translate/codecs |
